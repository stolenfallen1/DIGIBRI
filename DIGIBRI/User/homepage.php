...
<html lang="en">
    ...
    <body>
        ...
        <section id="home-section">
            ...
            <h2 class="typing"></h2>
            <button class="button" onclick="window.location.href='user_login.php'">Login Here</button>
        </section>
        ...
        <section id="contact-section">
            ...
            <div>
                <p><a href="https://www.facebook.com/" target="_blank"><i class="fa fa-facebook-official" aria-hidden="true"></i></a></p>
                <p><a href="#contact-section"><i class="fa fa-phone-square" aria-hidden="true"></i></a></p>

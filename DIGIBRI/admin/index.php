	...
	<body>
		<div class="container-fluid py-4">
			...
			<div class="row">
				...
				<div class="col-xl-3 col-md-6">
					<div class="card border-primary mb-3">
						...
						<div class="card-body text-primary">
							...
							<p class="card-text"> Total number of pending requests from library patrons. </p>
				...
				<div class="col-xl-3 col-md-6">
					<div class="card border-success mb-3">
						...
						<div class="card-body text-success">
							...
							<p class="card-text"> Total number of books in the library either active or inactive. </p>
							<!-- <a id="hoverbtn" href="#" class="btn btn-light">View Details</a> -->
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-6">
					<div class="card border-info mb-3">
						...
						<div class="card-body text-info">
							...
							<p class="card-text">Total number of active books available in the library. </p>
							<!-- <a id="hoverbtn" href="#" class="btn btn-light">View Details</a> -->
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-6">
					<div class="card border-warning mb-3">
						...
						<div class="card-body text-warning">
							...
							<p class="card-text"> Total number of library patrons registered. </p>
							<!-- <a id="hoverbtn" href="#" class="btn btn-light">View Details</a> -->
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-6">
					<div class="card border-primary mb-3">
						...
						<div class="card-body text-primary">
							...
							<p class="card-text"> Total number of books issued from the library. </p>
							<!-- <a id="hoverbtn" href="#" class="btn btn-light">View Details</a> -->
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-6">
					<div class="card border-success mb-3">
						...
						<div class="card-body text-success">
							...
							<p class="card-text"> Total number of borrowed books returned to the library. </p>
							<!-- <a id="hoverbtn" href="#" class="btn btn-light">View Details</a> -->
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-6">
					<div class="card border-info mb-3">
						<div class="card-header">Borrowed Books <i class="fa fa-book" aria-hidden="true"></i></div>
						<div class="card-body text-info">
							<h1 class="text-center"><?php echo book_borrowed($connect); ?></h1>
							<p class="card-text"> Total number of borrowed books from the library. </p>
							<!-- <a id="hoverbtn" href="#" class="btn btn-light">View Details</a> -->
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-md-6">
					<div class="card border-info mb-3">
						<div class="card-header">Unreturned Books <i class="fa fa-book" aria-hidden="true"></i></div>
						<div class="card-body text-info">
							<h1 class="text-center"><?php echo unreturned($connect); ?></h1>
							<p class="card-text"> Total number of unreturned books from the library. </p>
							<!-- <a id="hoverbtn" href="#" class="btn btn-light">View Details</a> -->
						</div>
					</div>
				</div><hr>

...
<div class="container-fluid py-4" style="min-height: 700px;">
	...
	<ol class="breadcrumb mt-4 mb-4 bg-light p-2 border">
		<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
		<li class="breadcrumb-item"><a href="user.php">Library Patron Management</a></li>
		<li class="breadcrumb-item active">Edit Library Patron</li>
	</ol>
	<div class="card mb-4">
    	<div class="card-header">
    		<i class="fas fa-user-edit"></i> Edit Library Patron
       	</div>
       	<div class="card-body">
				...
				<div class="row">
       				<div class="col-md-6">
       					<div class="mb-3">
       						<label class="form-label">First Name</label>
       						<input type="text" name="user_fname" id="user_fname" class="form-control" value="<?php echo $user_row['user_fname']; ?>" />
       					</div>
       				</div>
					<div class="col-md-6">
       					<div class="mb-3">
       						<label class="form-label">Last Name</label>
       						<input type="text" name="user_lname" id="user_lname" class="form-control" value="<?php echo $user_row['user_lname']; ?>" />
       					</div>
       				</div>
       			</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
       					<div class="mb-3">
       						<label class="form-label">Username</label>
       						<input type="text" name="user_name" id="user_name" class="form-control" value="<?php echo $user_row['user_name']; ?>" />
       					</div>
       				</div>
       			</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
       					<div class="mb-3">
       						<label class="form-label">Password</label>
       						<input type="password" name="user_password" id="user_password" class="form-control" value="<?php echo $user_row['user_password']; ?>" />
       					</div>
       				</div>
       			</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
       					<div class="mb-3">
       						<label class="form-label">Address</label>
       						<input type="text" name="user_address" id="user_address" class="form-control" value="<?php echo $user_row['user_address']; ?>" />
       					</div>
       				</div>
       			</div>
